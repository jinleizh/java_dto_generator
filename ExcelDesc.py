...
service_didi = {
    ...
    "sheets_name_dict": {
        ...
        "借款借据（试算）": "TryCompute",
        "放款申请": "LoanApply",
        "客户向下还款计划": "DownRepayment",
        "客户向下所有借款记录": "DownLoanRecord",
        "单笔借据对应的还款计划": "RepaymentPlan",
        "单笔借款详情": "SingleLoanDetail",
        "提前结清查询（含详情）": "AdvanceBillingQuery",
        "提前结清申请动作": "AdvanceBillingApply",
    },
